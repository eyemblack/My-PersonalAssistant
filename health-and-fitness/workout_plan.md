...
**เป้าหมาย:** สร้างกล้ามเนื้อสไตล์ Athletic + เพิ่มความทนทานแกนกลางและหัวใจเพื่อเตรียมเดินป่า (4-5 เดือนข้างหน้า)
...
*เน้นสร้างกล้ามเนื้อ อก, หลัง, ไหล่, แขน ด้วยบาร์โหน ยางยืด และบอดี้เวท*

| ท่าออกกำลังกาย (Exercise) | อุปกรณ์ | เซต (Sets) | จำนวนครั้ง (Reps) | พักระหว่างเซต (Rest) | คำแนะนำเพิ่มเติม |
| :--- | :--- | :---: | :---: | :---: | :--- |
| **1. Dynamic Warm-up** | - | 1 | 5-10 นาที | - | บริหารข้อมือ หัวไหล่ และแกนกลาง |
| **2. Pull-ups (โหนบาร์)** | บาร์โหน | 3-4 | 6-12 ครั้ง (หรือบวกยางยืดช่วยดึง) | 2 นาที | เน้นดึงข้อและบีบสะบักด้านหลัง (หลังกว้าง) |
| **3. Decline Push-ups** | ร่างกายตัวเอง + เก้าอี้ | 3 | 10-15 ครั้ง | 1.5 นาที | วางเท้าบนเก้าอี้เพื่อเน้นหน้าอกส่วนบน |
| **4. Resistance Band Single-Arm Row** | ยางยืด | 3 | 12-15 ครั้ง/ข้าง | 1 นาที | ดึงยางยืดเข้าหาเอว เน้นกล้ามเนื้อปีกและหลัง |
| **5. Resistance Band Overhead Press** | ยางยืด | 3 | 12-15 ครั้ง | 1.5 นาที | ยืนเหยียบสายยางยืด ดันมือขึ้นเหนือศีรษะ (ไหล่) |
| **6. Band Bicep Curls Super-set กับ Band Tricep Extensions** | ยางยืด | 3 | 15 ครั้งต่อท่า | 1 นาที | ฝึกต้นแขนหน้าและหลังสลับกันโดยไม่พัก |
...
| **6. Russian Twists (Banded)** | ยางยืด/ตัวเปล่า | 3 | 20 ครั้ง (ข้างละ 10) | 1 นาที | ฝึกกล้ามเนื้อท้องด้านข้าง (บิดตัวเพื่อการทรงตัว) |
